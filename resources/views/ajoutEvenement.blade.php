...
<body>
    <div class="registration-form">
        <form method="post" action="/ajout">
            ...
            <div class="form-group">
                <input type="text" name="description" class="form-control" id="description" placeholder="description de l'evenement">
            </div>
            ...
            <div class="form-group">
                <input type="number" name="nombre_de_passe" class="form-control" id="nombre_de_passe" placeholder="Nombre de places">
            </div>
